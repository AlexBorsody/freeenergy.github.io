...
$('#widget_area div#content_container .widget_input').focus(function() {
	...
	if ($("#pledge").val() == "") {  
	 ...
	 var dataString = 'pledge='+ a + '&signature=' + b + '&email=' + c +'&checkbox=' + d; 
	    $.ajax ( {
	    type: 'POST',	
	    data: dataString,
