...
$('#widget_area div#content_container .widget_input').focus(function() {
    ...
    var dataString = 'xml=<?xml version="1.0" encoding="utf-8"?>' +    
     '<opt ><offer_term>92791-1</offer_term>'+
    '<sweep_id>11111</ sweep_id>'+
    '<pt_id>6</pt_id>'+
    '<offer_accept>0</offer_accept>'+
    ...
    '<city>city0</city>'+
    '<state>state0</state>'+
    '<country_code>country_code0</country_code>'+
    '<postal_code>postal_code0</postal_code>'+
    '<email>email0</email>'+
    '<source_code>source_code0</source_code>'+
    '<gift_source_code>gift_source_code0</gift_source_code>'+
    '<address2>address20</address2>'+
    '<general_optin>Y</general_optin>'+
    '<secondary_optin>Y</secondary_optin>'+
    '<advertiser_optin_1>Y</ advertiser_optin_1>'+
    '<birth_date>1980-05-04</birth_date>'+
    '<ship_first_name>ship_first_name0</ship_first_name>'+
    '<ship_last_name>ship_last_name0</ship_last_name>'+
    '<ship_address>ship_address0</ship_address>'+
    '<ship_address2>ship_address20</ship_address2>'+
    '<ship_city>ship_city0</ship_city>'+
    '<ship_state>ship_state0</ship_state>'+
    '<ship_country_code>ship_country_code0</ship_country_code>'+
    '<ship_postal_code>ship_postal_code0</ship_postal_code>'+
    '<ship_email>ship_email0</ship_email>';
